...
│   └── netease-test.js               # 网易云脚本单元测试 + HAR 回归
└── docs/
...
- 修改脚本后跑 `node tests/jd-test.js` 和 `node tests/netease-test.js` 回归，通过后提交推送
...
感谢 [LINUX DO](https://linux.do) 社区，在这里认识了很多热心的佬友，学到了不少东西。
